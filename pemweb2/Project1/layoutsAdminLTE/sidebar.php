  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="../dashboard/dashboard.php" class="mx-100"><i class="fas fa-home"></i>Home</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="../periksa/data_periksa.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../pasien/data_pasien.php" class="nav-link">
              <i class="nav-icon far fa-image"></i>
              <p>
                Pasien
              </p>
          ...
          <li class="nav-item">
            <a href="../paramedik/data_paramedik.php" class="nav-link">
              <i class="nav-icon far fa-image"></i>
              <p>
                Paramedik
              </p>
